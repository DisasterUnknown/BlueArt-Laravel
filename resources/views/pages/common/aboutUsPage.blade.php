    ...
    <div class="space-y-4" id="aboutUs">
        <div class="space-y-4 min-h-[calc(100vh-92px)]" id="viewUsersPage">
            ...
            <div class="flex flex-col items-center justify-center py-10">
                ...
                <a href="{{ route('register') }}" class="border px-5 py-4 w-[50%] md:w-[20%] text-center font-bold rounded-xl hover:scale-105 hover:bg-blue-200 hover:text-black hover:shadow-[0_0_15px_2px_rgba(0,255,255,0.8)] transition-transform duration-300">Register Now</a>
            </div>
        </div>
